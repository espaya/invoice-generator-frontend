...
export default function AdminAddUser() {
  ...
  const [defaultPreview, setDefaultPreview] = useState("/images/avatar.png");
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      ...
      try {
        const res = await fetch(`${apiBase}/api/admin/users/view/${param}`, {
          credentials: "include",
          headers: {
        ...
        const photoUrl = data?.profile?.photo
          ? `${apiBase}/storage/${data?.profile?.photo}`
          : "/images/avatar.png";

        setPreview(photoUrl);
        setDefaultPreview(photoUrl);
  ...
  const removePhoto = () => {
    ...
    // if editing, restore existing photo
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // password only if entered (important for edit mode)
      ...
      const url = param
        ? `${apiBase}/api/admin/users/update/${param}`
        : `${apiBase}/api/admin/users`;

      const method = param ? "POST" : "POST";

      // Laravel needs POST + _method for update
      if (param) {
      ...
      if (!param) {
        ...
        setDefaultPreview("/images/avatar.png");
      } else {
        // if editing refresh preview state
            ...
            <div className="row align-items-center justify-content-between">
              <div className="col-md-6">
                <div className="page-title-content">
                  <h3>{param ? "Edit User" : "Add User"}</h3>
                  <p className="mb-2">
                    {param
                      ? "Update user account"
              ...
              <div className="col-auto">
                <div className="breadcrumbs">
                  ...
                  <a href="#">{param ? "Edit User" : "Add User"}</a>
                </div>
              </div>
            </div>
          </div>
